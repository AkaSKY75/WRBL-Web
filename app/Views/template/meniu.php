...
<div class="sidebar-dropdown"><a href="#">Navigation</a></div>
		...
		<li class="has_sub {clsusers}"><a href="#"><i class="fa fa-users"></i> Pacienti  <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            ...
            <ul>
              ...
              <li><a href="{SITE_URL}/users/index">Lista pacienti</a></li>             
              <li><a href="{SITE_URL}/users/adauga_pacient">Adauga pacient</a></li> 
			  <li><a href="{SITE_URL}/users/adauga_pacient">Adauga consult</a></li>
