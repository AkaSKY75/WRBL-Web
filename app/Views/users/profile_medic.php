<div class="row" style="padding-left: 10%;">
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-2"></div><!--<div class="col-md-6" style="margin-left:6%"><h1 >{nume_medic} {prenume_medic}</h1><a style="color:white; " href="{SITE_URL}/admin/edit_medic/{id_medic}"><button type="submit" style="background: #074486; min-width: 110px;" class="btn btn-orange submit em">Editeaza datele</button></a><!--<a style="color:white; padding-left:1%" href="{SITE_URL}/users/view_consultatii_pacient/{cnp}"><button type="submit" style="background: #6d81c0; " class="btn btn-orange submit">Vezi consultatii</button></a>-->
          ...
          <div class="form-group">
            ...
            <label class="col-lg-2 control-label">PRENUME</label>
              ...
              <div class="col-lg-5">
							  ...
							  <div class="form-control">{prenume}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{localitate}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{judet}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{strada}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{bloc}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{scara}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{etaj}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{apartament}</div>
            ...
            <div class="col-lg-5">
              ...
              <div class="form-control">{numar}</div>
          ...
          <div class="form-group">
            ...
            <label class="col-lg-2 control-label">CALIFICARE</label>
              ...
              <div class="col-lg-5">
                ...
                <div class="form-control">{calificare} </div>
